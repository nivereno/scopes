...
pub static SCOPES_VERSION_MAJOR: usize = 0;
pub static SCOPES_VERSION_MINOR: usize = 19;
pub static SCOPES_VERSION_PATCH: usize = 0;

// trace partial evaluation and code generation
// produces a firehose of information
pub static SCOPES_DEBUG_CODEGEN: usize = 0;

// any location error aborts immediately and can not be caught
pub static SCOPES_EARLY_ABORT: usize = 0;

// print a list of cumulative timers on program exit
pub static SCOPES_PRINT_TIMERS: usize = 0;

// if 0, will never cache modules
pub static SCOPES_ALLOW_CACHE: usize = 1;

// if 1, will warn about missing C type support, such as for some union types
pub static SCOPES_WARN_MISSING_CTYPE_SUPPORT: usize = 0;

// maximum size in bytes of object cache. by default, this is set to 100 MB
pub static SCOPES_MAX_CACHE_SIZE: usize = (100 << 20);
...
pub static SCOPES_MAX_CACHE_INODES: usize = 63000;
...
pub static SCOPES_MAX_RECURSIONS: usize = 64;

// folder name in ~/.cache in which all cache files are stored
pub static SCOPES_CACHE_DIRNAME: &str = "scopes";

// compile native code with debug info if not otherwise specified
pub static SCOPES_COMPILE_WITH_DEBUG_INFO: usize = 1;
